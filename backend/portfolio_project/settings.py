...
# Add your render app's hostname for health checks
...
# This block was missing and is required by the Django admin.
TEMPLATES = [
    {
...
# --- STATIC AND MEDIA FILES CONFIGURATION FOR RENDER DISK ---
STATIC_URL = 'static/'
